...
mmc = metric_learn.MMC_Supervised(max_iter = 1000, max_proj = 1000, convergence_threshold=1e-3,
                                              num_constraints=100,verbose=True, diagonal_c = 1)
mmc.fit(features_train_pca, train_label_new)
            
# transform our input space
features_train2 = mmc.transform(features_train1)
features_valid2 = mmc.transform(features_valid1)
features_query2 = mmc.transform(features_query1)
features_gallery2 =mmc.transform(features_gallery1)
